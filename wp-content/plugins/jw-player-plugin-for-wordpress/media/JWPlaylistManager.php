              ...
              <?php foreach ($playlist_items as $key => $playlist_item) { ?>
                <tr id="post-<?php echo $playlist_item->ID; ?>" class="alternate author-self status-inherit playlist-item" valign="top" style="width: 475px;">
                  <td class="column-icon media-icon">
                    ...
                    <?php $image = $mime_type == "image" ? $playlist_item->guid : "http://10.169.0.141/wordpress/wp-includes/images/crystal/video.png"; ?>
            ...
            <thead>
              <tr>
                ...
                <th scope="col" id="title" class="manage-column column-title <?php echo $file_class; ?>" style="">
                  <a class="sort-links" href="http://10.169.0.141/wordpress/wp-admin/upload.php?page=jwplayer-playlists&orderby=title&amp;order=<?php echo $file_order; ?>">
                    <span>File</span>
                    <span class="sorting-indicator"></span>
                  </a>
                </th>
                <th scope="col" id="author" class="manage-column column-author <?php echo $author_class; ?>" style="width: 20%;">
                  <a class="sort-links" href="http://10.169.0.141/wordpress/wp-admin/upload.php?page=jwplayer-playlists&orderby=post_author&amp;order=<?php echo $author_order; ?>">
                    <span>Author</span>
                    <span class="sorting-indicator"></span>
                  </a>
                </th>
                <th scope="col" id="date" class="manage-column column-date <?php echo $date_class; ?>" style="width: 20%;">
                  <a class="sort-links" href="http://10.169.0.141/wordpress/wp-admin/upload.php?page=jwplayer-playlists&orderby=date&amp;order=<?php echo $date_order; ?>">
                    <span>Date</span>
                    <span class="sorting-indicator"></span>
                  </a>
                </th>
            ...
            <tbody id="the-list">
              ...
              <tr id="post-<?php echo $media_item->ID; ?>" class="alternate author-self status-inherit" valign="top" style="width: 475px;">
                <td class="column-icon media-icon">
                  ...
                  <?php $image = $mime_type == "image" ? $media_item->guid : "http://10.169.0.141/wordpress/wp-includes/images/crystal/video.png"; ?>
                  <?php $width = $mime_type == "image" ? "32" : "24"; ?>
                  <img width="<?php echo $width; ?>" height="32" src="<?php echo $image; ?>"
