...
//Commented by Gaurav
//$currentDIR= str_replace("/wp-content/plugins/bb-agency/theme","",getcwd());
$currentDIR= str_ireplace(DIRECTORY_SEPARATOR."wp-content".DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."bb-agency".DIRECTORY_SEPARATOR."theme","",getcwd());
