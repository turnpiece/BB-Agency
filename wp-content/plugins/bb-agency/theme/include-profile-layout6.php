...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $('#division').change(function() {   
	        ...
	        $.post('<?php echo get_bloginfo("url");?>/wp-content/plugins/bb-agency/theme/sub_db_handler.php', qString, processResponse);
	    });
			...
			<form action="" method="post" target="_blank">
				...
				<div id="polaroids" class="col_8 column">
					...
					<div class="col_6 column">
						...
						<div class="polaroid">
							<img src="/wp-content/plugins/bb-agency/theme/custom-layout6/images/polariod-four-per-page.png" alt="" />
						</div><!-- polariod -->
					</div><!-- .six .column -->
					...
					<div class="col_6 column">
						...
						<div class="polaroid">
							<img src="/wp-content/plugins/bb-agency/theme/custom-layout6/images/polariod-one-per-page.png" alt="" />
						</div><!-- polariod -->
					</div><!-- .six .column -->
			...
			<form action="" method="post" target="_blank">
				...
				<div id="polaroids" class="col_8 column">
					<div class="col_6 column">
						...
						<div class="polaroid">
							<img src="/wp-content/plugins/bb-agency/theme/custom-layout6/images/polariod-large-photo-with-model-info.png" alt="" />
						</div><!-- polariod -->
					</div><!-- .six .column -->
					...
					<div class="col_6 column">
						...
						<div class="polaroid">
							<img src="/wp-content/plugins/bb-agency/theme/custom-layout6/images/polariod-medium-photo-with-model-info.png" alt="" />
						</div><!-- polariod -->
					</div><!-- .six .column -->
					...
					<div class="col_6 column">
						...
						<div class="polaroid">
							<img src="/wp-content/plugins/bb-agency/theme/custom-layout6/images/polariod-large-photo-without-model-info.png" alt="" />
						</div><!-- polariod -->
					</div><!-- .six .column -->
					...
					<div class="col_6 column">
						...
						<div class="polaroid">
							<img src="/wp-content/plugins/bb-agency/theme/custom-layout6/images/polariod-medium-photo-without-model-info.png" alt="" />
						</div><!-- polariod -->
					</div><!-- .six .column -->
