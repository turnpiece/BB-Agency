...
<?php
function render_content($url,$width,$height,$type, $title){
		$vid=""; $content=""; $url=trim($url);
		if(!empty($url)){
			if($type == "vid"){
					$vid ='<object width="713" height="505">
								<param name="movie" value="https://www.youtube.com/v/'.$url.'?version=3"></param>
								  <param name="allowFullScreen" value="true"></param>
								  <param name="allowScriptAccess" value="always"></param>
								  <embed src="https://www.youtube.com/v/'.$url.'?version=3" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="'.$width.'" height="'.$height.'"></embed>
								</object>';
					return $vid;			
			} elseif($type == "img") {
					$content ='<span class="video_player" style="background-image: url(http://img.youtube.com/vi/'.$url.'/default.jpg)" title="'.$title.'"></span>';
					return $content;
			}
		}
		return false;
		  ...
		  <div id="video_player" class="col_8 column" style="display:none; position:relative; ">	
			...
			<script type="text/javascript">
					...
					jQuery(document).ready(function(){
						  ...
						  jQuery("#videos-carousel").find("li").click(function(){
							 ...
							 // jQuery("#vid_changer").show();
							 // jQuery("#vid_changer").css({opacity:0});
							 // jQuery("#vid_changer").animate({opacity:1},1000,function(){
							//	  jQuery(".vids").hide();
								  _curr.removeClass("act_vids");
								  _curr.hide();	
								  jQuery(_next).parent().show();
								  jQuery(_next).parent().addClass("act_vids");
							//	  jQuery("#vid_changer").animate({opacity:0},1000,function(){
							//	  	jQuery("#vid_changer").hide();		  
							//	  });
							 // });
						  });
						  
						  //jQuery("#video_player").width(jQuery("#profile-slider").width()+"px");
						  //jQuery(".vids").width(jQuery("#video_player").width()+"px");
			...
			<ul id="profile-links">
				...
				<?php
					...
					<li><a href="" class="showSingle1" target="1">Pictures</a></li>
					<li><a href="" class="showSingle2" target="3">Experience</a></li>
					<li><a href="" class="showSingle3" target="2">Videos</a></li>
