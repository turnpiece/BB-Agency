<?php
	...
	echo "	<tbody>\n";
	echo "    <tr valign=\"top\">\n";
	echo "		<td scope=\"row\" class=\"label\"><span style=\"width:185px;float:left;\">". __("Last updated ", bb_agencyinteract_TEXTDOMAIN) ." ". bb_agency_makeago(bb_agency_convertdatetime($ProfileDateUpdated), $bb_agency_option_locationtimezone) ."</span></th>\n";
	echo "		<td>\n";
