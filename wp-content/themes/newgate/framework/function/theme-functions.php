...
if (function_exists('add_theme_support')) {
    ...
    set_post_thumbnail_size(860, 485, true);
}

if (function_exists('add_image_size')) {
	add_image_size('project-thumb', 440, 280, true);
	add_image_size('project-thumb-half', 610, 390, true);
	add_image_size('project-thumb-full', 1160, 740, true);
	add_image_size('slider-thumb', 860, 9999);
	add_image_size('full-thumb', 1160, 655, true);
...
function cmsms_get_tweets($username, $count) {
	...
	$connection = new TwitterOAuth( 
		'o8ej4zq4uG5LtNlpbAkjA', 
		'W1YL6BDdHmaqRdnx8CxMGtSc7nV9nsQV0qobL8qrU', 
		'298558518-TBHJO5lqD4YyasHx5IxpOhe8XDmMxpI513MtAp5F', 
		'Iy3QbojR7SmO94hUFAUL5No2pr3BYA72FVuKJ8IaBs' 
	);
