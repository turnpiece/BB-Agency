...
function cmsms_theme_customizer($wp_customize) {
	...
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_style_header[' . CMSMS_SHORTNAME . '_header_nav_right]', array( 
		'label' => __('Header Navigation Right Position', 'cmsmasters'), 
		'section' => 'cmsms_header_section', 
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_logo_text[' . CMSMS_SHORTNAME . '_text_logo_title]', array( 
		'default' => ((get_bloginfo('name')) ? get_bloginfo('name') : 'Newgate'), 
		'type' => 'option' 
	) );
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_style_bg[' . CMSMS_SHORTNAME . '_boxed_version]', array( 
		'default' => 0, 
		'type' => 'option' 
	) );
	
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_style_bg[' . CMSMS_SHORTNAME . '_boxed_version]', array( 
		'label' => __('Boxed Version', 'cmsmasters'), 
		'section' => 'cmsms_bg_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_style_bg[' . CMSMS_SHORTNAME . '_boxed_version]', 
		'type' => 'checkbox', 
		'priority' => '1' 
	) );
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_font_color]', array( 
		'default' => '#979797', 
		'type' => 'option', 
		'transport' => 'postMessage' 
	) );
	...
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, CMSMS_SHORTNAME . '_footer_font_font_color', array( 
		'label' => __('Font Color', 'cmsmasters'), 
		'section' => 'cmsms_font_footer_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_font_color]', 
		'priority' => '3' 
	) ) );
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_portfolio_full[' . CMSMS_SHORTNAME . '_portfolio_full_date]', array( 
		'default' => 1, 
		'type' => 'option' 
	) );
	
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_portfolio_full[' . CMSMS_SHORTNAME . '_portfolio_full_date]', array( 
		'label' => __('Project Date', 'cmsmasters'), 
		'section' => 'cmsms_portfolio_full_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_portfolio_full[' . CMSMS_SHORTNAME . '_portfolio_full_date]', 
		'type' => 'checkbox', 
		'priority' => '4' 
	) );
