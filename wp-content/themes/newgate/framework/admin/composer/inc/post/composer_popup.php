			...
			<table class="describe">
				<tbody>
					...
					<tr>
						...
						<td class="field" style="padding-top:10px;">
							<input type="text" value="<?php echo ($content != '' && $post['post_number']) ? $post['post_number'] : '3'; ?>" name="post_number" id="post_number" aria-required="true" class="popup_tr_value" style="width:45px;" />
						</td>
					</tr>
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
